...
#chronicleEntries{max-height:560px;overflow-y:auto;padding-right:6px;position:relative}
.claim-card{position:relative}
.claim-card::before{content:"";position:absolute;left:-12px;top:50%;width:12px;height:1px;background:#4c5258;pointer-events:none}
.claim-card::after{content:"";position:absolute;left:-12px;top:-8px;bottom:-12px;width:1px;background:#4c5258;pointer-events:none}
.claim-card:first-child::after{top:50%}
.claim-card:last-child::after{bottom:50%}
.claim-card.identity-correction-card::before{left:-32px;width:32px}
.claim-card.identity-correction-card::after{left:-32px}
